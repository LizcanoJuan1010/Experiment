...
Requires GPT-2 Small via TransformerLens (GPU recommended, CPU ~15 min).
...
LAYERS = cfg.EXTRACTION_LAYERS  # [6, 9, 10]
...
def fig17_token_heatmap(model, data):
    ...
    n_layers_total = model.cfg.n_layers  # 12 for GPT-2 Small
