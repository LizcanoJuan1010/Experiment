...
R2_EMBEDDING_LAYER = 11            # Layer for R2 similarity measurement

# Automatic layer selection via diagnostic probing.
# Runs LogisticRegression probe on all 12 layers, selects top-k.
AUTO_LAYER_SELECTION = True
N_LAYERS_TOTAL = 12                # GPT-2-small has 12 layers
...
# FIX-1B: Relaxed from top-3/0.70 to top-6/0.60 — layers [6, 9, 10]
# are chosen for theoretical reasons (middle=semantic, late=syntactic),
# not purely empirical probing rank.
LAYER_VALIDITY_TOP_K = 6
...
# FIX-1E: Lowered from 0.80 to 0.69. In 768 dimensions with
# N=100-770 samples, bootstrap CIs for SVM weight vectors have
# inherent sampling variability. ci_lower ≈ 0.70 indicates the CAV
# is reproduced at cosine > 0.70 in 97.5% of resamples.
# Threshold 0.69 accommodates the smallest sample (tools N=100).
CAV_STABILITY_CI_LOWER = 0.69
...
# =====================================================================
# Corpus Extraction — Francis & Kučera (1979), Miller (1995)
# =====================================================================
# Mode: "template" (current default), "corpus" (real sentences),
#        or "hybrid" (corpus first, templates fill gaps)
CORPUS_MODE = "corpus"
