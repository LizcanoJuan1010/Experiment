"""
BEA Naming Test — Confrontation Naming with Ablation (Pythia 2.8B)
=====================================================================
...
def evaluate_with_hooks(model, dataset, fwd_hooks):
    """Evaluate BEA naming benchmark with ablation hooks active."""
    if not fwd_hooks:
...
def main():
    print("=" * 60)
    print("BEA Naming Test — Confrontation Naming with Ablation (Pythia 2.8B)")
    print("=" * 60)
    ...
    # Naming benchmark uses 3 broad categories: "time", "place", "tools"
    # Map our 30 concepts to these categories based on semantic field.
    category_mapping = {
    ...
    # Keep only concepts that fall into our mapped categories
