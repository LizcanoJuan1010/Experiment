...
=======================================
Interactive chat with Pythia 2.8B where you can ablate concept CAVs
...
CAV_DIR = "cavs"
LAYER = 16  # Proportional to GPT-2's L6 (50% depth)
...
def main():
    ...
    for c in ["time", "place", "tools"]:
        ...
        if os.path.exists(path):
            concepts[c] = torch.load(path, weights_only=True).to(model.cfg.device)
