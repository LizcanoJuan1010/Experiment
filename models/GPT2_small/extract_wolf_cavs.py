...
Wolf CAV Extraction
===================
Extracts Concept Activation Vectors for the "wolf" concept at all 12
layers, using both mean_diff and SVM methods.
...
CONCEPT = "wolf"
LAYERS = list(range(cfg.N_LAYERS_TOTAL))  # All 12 layers (for all_layers condition)
