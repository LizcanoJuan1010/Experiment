"""
CCT Test — Camel and Cactus Test (Semantic Intruder Detection with Ablation)
=====================================================================
...
Usage (inside Docker):
    docker run --gpus all -it tesis-gpt2 python -m test.bea_oddoneout_test
...
# Ensure parent directory is in path (needed when running as python -m test.bea_oddoneout_test)
...
def main():
    ...
    print("=" * 60)
    print("BEA Odd-One-Out Test  Semantic Intruder Detection with Ablation")
    print("=" * 60)
