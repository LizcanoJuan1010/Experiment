...
Resultados del experimento de ablacion multi-capa usando vectores SVM sin normalizar. Mejora significativa respecto al experimento original: deltaR1 hasta +0.333 (vs +0.07 del original).
...
### Controles de amplificacion

| Concepto | deltaR1 | Valido |
|----------|---------|--------|
